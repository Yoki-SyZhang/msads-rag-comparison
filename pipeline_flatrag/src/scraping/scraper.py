"""
Stage 1 scraper for UChicago MS-ADS RAG chatbot.
Fetches URLs from docs/url_class_reference.json and saves full raw HTML to data/raw/.
Playwright is used for FAQs and Course Progressions (JS accordion content).
All other pages use requests + BeautifulSoup4.
"""
...
if __name__ == "__main__":
    ...
    scrape_all(
        url_class_reference_path=str(base / "docs" / "url_class_reference.json"),
